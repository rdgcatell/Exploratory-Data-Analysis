...
plot(pow_con_dt[, dateTime], pow_con_dt[, Sub_metering_1], type="l", xlab="", ylab="Energy sub metering")
lines(pow_con_dt[, dateTime], pow_con_dt[, Sub_metering_2],col="red")
lines(pow_con_dt[, dateTime], pow_con_dt[, Sub_metering_3],col="blue")
legend("topright"
